...
import com.spontecorp.losarboles.controller.locales.ListaLocalesController;
...
public class RootLayoutController implements Initializable {
    ...
    @FXML
    private void handleMenuListaLocales(ActionEvent event){
        application.showNewBase(Utilidades.LOCALES_LISTA, new ListaLocalesController());
    }
}
